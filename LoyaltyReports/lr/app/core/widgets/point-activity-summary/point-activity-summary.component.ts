...
@Component({
  selector: 'point-activity-summary',
  templateUrl: './point-activity-summary.component.html',
  styleUrls: ['./point-activity-summary.component.scss']
})
export class PointActivitySummaryComponent implements OnInit {
    ...
    ngOnInit() {
      ...
      requestObject.tileId = "points_activity_summary";
      //remove later
